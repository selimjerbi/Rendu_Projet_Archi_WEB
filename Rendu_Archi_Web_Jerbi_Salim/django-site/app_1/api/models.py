...
class Registration(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='api_registrations')  # Changement ici
    weekend = models.ForeignKey(IntegrationWeekend, on_delete=models.CASCADE)
    services = models.ManyToManyField(ServiceChoice, blank=True, related_name='api_registrations')  # Changement ici
